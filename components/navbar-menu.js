                ...
                <nav class="navbar">
                    <div class="navbar-desktop items-center justify-between w-full">
                        <div class="flex items-center gap-8">
                            <a class="nav-item ${isActive('opensource.html')}" href="opensource.html">OpenSource</a>
                            <a class="nav-item ${isActive('project.html')}" href="project.html">Projects</a>
                            <a class="nav-item ${isActive('study')}" href="study/index.html">Research</a>
                        </div>
                    ...
                    <div id="mobile-menu" class="hidden absolute top-0 right-0 bg-black w-full mt-14 z-50 text-right border-b-2 border-white">
                        ...
                        <a class="block py-3 px-4 text-white hover:bg-gray-800" href="study/index.html">Research</a>
                        <a class="block py-3 px-4 text-white hover:bg-gray-800" href="opensource.html">OpenSource</a>
