# Design System — Sourav Rajvi Portfolio
...
- **Desktop** (`.navbar-desktop`, `md+`): 3-column layout — Blog/Projects left, SR logo center, About/Contact right
...
| `opensource.html` | Open-source contributions list |
